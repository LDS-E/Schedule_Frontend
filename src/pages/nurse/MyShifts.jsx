...
const shiftColors = {
  night: "bg-blue-500 text-white",
  day: "bg-pink-300 text-white",
  halfday: "bg-green-300 text-white",
};

const MyShifts = ({ loggedInNurseId }) => {
  ...
  const generateDaysGrid = (month) => {
    ...
    return [...emptyDays, ...totalDaysInMonth];
  };
    ...
    <div className="max-w-6xl mx-auto p-4 flex gap-6 bg-[url('./src/backgrounds/2.png')] min-h-screen flex-col bg-cover bg-center">
      ...
      <div className="border-4 border-gray-700 shadow-2xl bg-white/35 p-4 rounded-lg">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold text-black shadow-lg">My Shifts</h1>
